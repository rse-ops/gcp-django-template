...
admin.site.site_header = "gcp-django-template Administration"
admin.site.site_title = "gcp-django-template Admin"
admin.site.index_title = "gcp-django-template administration"
